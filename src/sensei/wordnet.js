...
class WordnetSensei {
  ...
  basic() {
  	...
  	async.eachSeries(basicPOS.keys(), (basicPosAbbreviation, cb) => {
  		const basicPosWord = basicPOS[basicPosAbbreviation];
	  	self.apiClient.createStoredFunction(basicPosWord, null, basicPosWord, 'string', null, 0, null, null, null, null, (err, freeIdentifier) => {
